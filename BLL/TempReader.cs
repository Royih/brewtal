...
namespace Brewtal.BLL
{
    ...
    public class TempReader : ITempReader
    {
        ...
        private readonly GpioPin CsPin1;
        private readonly GpioPin CsPin2;
        private readonly GpioPin MisoPin;
        private readonly GpioPin MosiPin;
        private readonly GpioPin ClkPin;
        private readonly GpioPin TempReadHeartbeat;

        public TempReader(ILogger<TempReader> logger)
        {
            _logger = logger;

            CsPin1 = Pi.Gpio.GetGpioPinByBcmPinNumber(7);
            CsPin2 = Pi.Gpio.GetGpioPinByBcmPinNumber(8);
            MisoPin = Pi.Gpio.GetGpioPinByBcmPinNumber(9);
            MosiPin = Pi.Gpio.GetGpioPinByBcmPinNumber(10);
            ClkPin = Pi.Gpio.GetGpioPinByBcmPinNumber(11);
            TempReadHeartbeat = Pi.Gpio.GetGpioPinByBcmPinNumber(5);
        ...
        private void WriteRegister(byte regNum, byte dataByte, GpioPin csPin)
        {
            csPin.Write(false);
        ...
        private byte[] ReadRegisters(byte regNumStart, int numRegisters, GpioPin csPin)
        {
