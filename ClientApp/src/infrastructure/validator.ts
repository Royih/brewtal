...
export class ValidationElement implements IValidationElement {
  ...
  validate = (allElements: IValidationElement[]): void => {
    ...
    if (this.validationOptions.min && !this.validationOptions.max && this.value && +this.value < this.validationOptions.min) {
      this.errors.push(`The value must be at least ${this.validationOptions.min}`);
    } else if (this.validationOptions.max && !this.validationOptions.min && this.value && +this.value > this.validationOptions.max) {
      this.errors.push(`The value cannot be greater than ${this.validationOptions.max}`);
    } else if (this.validationOptions.max && this.validationOptions.min && this.value && (+this.value > this.validationOptions.max || +this.value < this.validationOptions.min)) {
      this.errors.push(`The value must be between ${this.validationOptions.min} and ${this.validationOptions.max}`);
    }
  };
}
